...
export default function CTABanner() {
  ...
  return (
    <section className="py-10 sm:py-14 md:py-20">
      ...
      >
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-gold-400/15 bg-gradient-to-br from-chocolate-900 via-espresso to-chocolate-950 p-6 sm:p-10 md:p-14 text-center shadow-2xl">
          {/* Glow */}
          ...
          <motion.div variants={fadeUp} custom={1} className="relative mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4 sm:px-0">
            <button
